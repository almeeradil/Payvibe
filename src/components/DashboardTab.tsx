                  ...
                  return (
                    <tr key={item.id} className="hover:bg-rose-50/40 transition">
                      ...
                      <td className="p-3 text-right">
                        <button
                          onClick={() => onNavigateTab('inventory')}
                          className="px-2.5 py-1 bg-slate-900 hover:bg-slate-800 text-white text-[11px] font-bold rounded-lg transition shadow-xs flex items-center gap-1 ml-auto cursor-pointer"
                        >
