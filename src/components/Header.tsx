      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="relative hidden md:block w-48 lg:w-64">
          ...
          <input
            ...
            className="w-full pl-8 pr-3 py-1.5 text-xs bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:bg-white transition"
          />
        </div>
        ...
        <div className="relative">
          <select
            ...
            className="text-xs font-bold bg-slate-100 hover:bg-slate-200 text-slate-800 border border-slate-300 rounded-lg px-3 py-1.5 pr-7 cursor-pointer focus:outline-none focus:ring-2 focus:ring-orange-500 appearance-none transition"
          >
        ...
        <button
          ...
          className="hidden lg:flex items-center space-x-1 px-2.5 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg font-bold text-xs border border-slate-200 transition"
