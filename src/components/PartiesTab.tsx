      ...
      <div className="flex border-b border-slate-200 space-x-4 text-xs font-bold">
        <button
          ...
          className={`pb-2.5 flex items-center gap-1.5 transition ${
            activeTab === 'customers' ? 'border-b-2 border-indigo-600 text-indigo-600' : 'text-slate-500 hover:text-slate-800'
          }`}
        >
        ...
        <button
          ...
          className={`pb-2.5 flex items-center gap-1.5 transition ${
            activeTab === 'suppliers' ? 'border-b-2 border-indigo-600 text-indigo-600' : 'text-slate-500 hover:text-slate-800'
          }`}
        >
            ...
            <tbody className="divide-y divide-slate-100">
              {filteredCustomers.map(c => (
                <tr key={c.id} className="hover:bg-slate-50">
                  ...
                  <td className="p-3 font-mono font-bold text-slate-700">{c.ntnGst || 'N/A'}</td>
            ...
            <tbody className="divide-y divide-slate-100">
              {filteredSuppliers.map(s => (
                <tr key={s.id} className="hover:bg-slate-50">
                  ...
                  <td className="p-3 font-mono font-bold text-slate-700">{s.ntnGst || 'N/A'}</td>
                  <td className="p-3 font-mono text-[11px] text-slate-600">{s.bankAccount || 'Direct Clearing'}</td>
            ...
            <form onSubmit={handleSaveCustomer} className="space-y-3 text-xs">
              ...
              <div className="bg-indigo-50/50 p-3 rounded-lg border border-indigo-100 mb-2">
                ...
                <select
                  ...
                  className="w-full px-3 py-1.5 border border-indigo-200 rounded-lg bg-white text-indigo-900 font-bold"
                >
              ...
              <div>
                <label className="block text-[10px] font-bold uppercase text-slate-500 mb-1">Customer / Pharmacy Name *</label>
                <input
                  type="text"
                  value={cName}
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block text-[10px] font-bold uppercase text-slate-500 mb-1">Membership Tier</label>
                  <select
                    value={cTier}
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-[10px] font-bold uppercase text-slate-500 mb-1">Phone Contact *</label>
                  <input
                    type="text"
                    value={cContact}
                ...
                <div>
                  <label className="block text-[10px] font-bold uppercase text-slate-500 mb-1">NTN / GST Number</label>
                  <input
                    type="text"
                    value={cNtnGst}
              ...
              <div>
                <label className="block text-[10px] font-bold uppercase text-slate-500 mb-1">Address / Street</label>
                <input
                  type="text"
                  value={cAddress}
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl shadow-2xl max-w-lg w-full p-6 border border-slate-200">
            <div className="flex justify-between items-center pb-3 border-b border-slate-200 mb-4">
              ...
              <button onClick={() => setShowAddSupplierModal(false)} className="text-slate-400 hover:text-slate-600">✕</button>
            </div>
            ...
            <form onSubmit={handleSaveSupplier} className="space-y-3 text-xs">
              ...
              <div className="bg-slate-100 p-3 rounded-lg border border-slate-200 mb-2">
                ...
                <select
                  ...
                  className="w-full px-3 py-1.5 border border-slate-300 rounded-lg bg-white text-slate-900 font-bold"
                >
              ...
              <div>
                <label className="block text-[10px] font-bold uppercase text-slate-500 mb-1">Supplier / Vendor Name *</label>
                <input
                  type="text"
                  value={sName}
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block text-[10px] font-bold uppercase text-slate-500 mb-1">NTN / Sales Tax #</label>
                  <input
                    type="text"
                    value={sNtnGst}
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block text-[10px] font-bold uppercase text-slate-500 mb-1">Bank Account / Clearing</label>
                  <input
                    type="text"
                    value={sBankAcount}
              ...
              <div>
                <label className="block text-[10px] font-bold uppercase text-slate-500 mb-1">Factory / Office Address</label>
                <input
                  type="text"
                  value={sAddress}
